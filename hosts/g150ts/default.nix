...

{
  ...
  sops.secrets."transmission_username".sopsFile = config.sops.secretsDir + /hosts/g150ts.yaml;
  sops.secrets."transmission_password".sopsFile = config.sops.secretsDir + /hosts/g150ts.yaml;
